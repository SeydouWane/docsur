...
export const categories: Categorie[] = [
  {
    ...
    outils: [
      ...
      },
      {
        ...
        description: "Glisser-déposer les pages pour changer leur ordre.",
        icon: ListOrdered,
        traitement: "local",
        statut: "bientot",
      },
  ...
  },
  {
    ...
    outils: [
      ...
      },
      {
        ...
        description: "Poser un texte ou une image en surimpression sur chaque page.",
        icon: Droplets,
        traitement: "local",
        statut: "bientot",
      },
      {
        slug: "rogner",
        nom: "Rogner PDF",
        description: "Recadrer les marges ou une zone précise des pages.",
        icon: Crop,
        traitement: "local",
        statut: "bientot",
      },
