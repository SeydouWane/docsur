  ...
  },
  {
    ...
    outils: [
      ...
      },
      {
        slug: "modifier",
        nom: "Modifier PDF",
        description: "Ajouter texte ou images directement sur le document.",
        icon: Edit3,
        traitement: "local",
        statut: "disponible",
      },
    ...
    outils: [
      {
        slug: "formulaires",
        nom: "Formulaires PDF",
        description: "Créer des champs de formulaire remplissables.",
        icon: ClipboardList,
        traitement: "local",
        statut: "disponible",
      },
  ...
  },
  {
    ...
    outils: [
      ...
      },
      {
        slug: "proteger",
        nom: "Protéger PDF",
        description: "Chiffrer un PDF avec un mot de passe d'ouverture (AES-256).",
        icon: Lock,
        traitement: "serveur",
        statut: "disponible",
      },
